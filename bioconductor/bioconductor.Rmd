...
gtf_data #bioconductor shows first 5 and last 5 rows
```
...
```{r}
assay_counts <- read.csv("/t1-data/project/obds/shared/resources/3_r_stats_genomics/r_bioconductor/summarized_experiment/counts.csv", row.names = "X")
